...
@level1type=N''TABLE'',@level1name=N''' + t.TABLE_NAME + ''';' AS sql1
 ...
 SELECT t_c.TABLE_SCHEMA 
      ,t_c.TABLE_NAME
	  ,t_c.COLUMN_NAME
,'EXEC sys.sp_addextendedproperty @name=N''MS_Description'',
@value=N''Primary key for Position records.'' ,
@level0type=N''SCHEMA'',@level0name=N''dbo'',
@level1type=N''TABLE'',@level1name=N''' + t_c.TABLE_NAME + ''',
@level2type=N''COLUMN'',@level2name=N''' + t_c.COLUMN_NAME + ''';'
as sql1
  FROM INFORMATION_SCHEMA.COLUMNS as t_c
 WHERE  t_c.TABLE_SCHEMA = 'dbo'
...
EXEC sys.sp_addextendedproperty 
     @name = N'MS_Description', 
     @value = N'Primary key for Customer', 
     @level0type = N'SCHEMA', 
     @level0name = N'dbo', 
     @level1type = N'TABLE', 
     @level1name = N'stg_p1', 
...
EXEC sys.sp_addextendedproperty 
     @name = N'MS_Description', 
     @value = N'Since when is a customer', 
     @level0type = N'SCHEMA', 
     @level0name = N'dbo', 
     @level1type = N'TABLE', 
     @level1name = N'stg_p1', 
